...
from .views import BlogListView, BlogDetailView, BlogCreateView, BlogEditView, BlogDeletePostView, Register, CommentListView, CreateComment
...
urlpatterns = [
    ...
    path('comment/new', CreateComment.as_view(), name='new_comment'),
